...
const SKILLS: SkillDef[] = [
  ...
  },
  {
    ...
    description: 'Instagram management: media, stories, reels insights, comments, shopping, profile',
    command: 'meta-ads instagram',
    examples: [
      'meta-ads instagram profile 123',
      'meta-ads instagram media 123 --limit 10',
      'meta-ads instagram media-insights 456',
      'meta-ads instagram stories 123',
      'meta-ads instagram story-insights 456',
      'meta-ads instagram comments 789',
      'meta-ads instagram reply-comment 101 --message "Thanks!"',
      'meta-ads instagram insights 123 --time-range last_7d',
      'meta-ads instagram sync-catalog --instagram-id 123 --catalog-id 456',
      'meta-ads instagram shopping-insights 123',
    ],
  },
  {
    name: 'meta-ads-threads',
    description: 'Threads content publishing, insights, replies, conversation threads, and search',
    command: 'meta-ads threads',
    examples: [
      'meta-ads threads profile',
      ...
      'meta-ads threads list --limit 10',
      'meta-ads threads get 12345',
      'meta-ads threads replies 12345',
      'meta-ads threads conversation 12345',
      'meta-ads threads insights --metrics views,likes,replies,followers_count',
      'meta-ads threads post-insights 12345',
      'meta-ads threads search "buildify"',
      'meta-ads threads delete 12345',
      'meta-ads threads hide-reply 67890',
    ],
  },
  {
    name: 'meta-ads-pages',
    description: 'Facebook Page management: posts, comments, insights, videos, live, events',
    command: 'meta-ads pages',
    examples: [
      'meta-ads pages list',
      'meta-ads pages get 12345',
      'meta-ads pages posts 12345 --limit 10',
      'meta-ads pages create-post 12345 --message "Hello world!"',
      'meta-ads pages create-post 12345 --message "Check this out" --link https://example.com',
      'meta-ads pages comments 67890',
      'meta-ads pages reply 11111 --message "Thanks!"',
      'meta-ads pages insights 12345 --time-range last_7d',
      'meta-ads pages post-insights 67890',
      'meta-ads pages videos 12345',
      'meta-ads pages live-videos 12345',
      'meta-ads pages create-live 12345 --title "Live Q&A"',
      'meta-ads pages events 12345',
      'meta-ads pages create-event 12345 --name "Product Launch" --start-time 2026-04-01T10:00:00',
    ],
  },
  {
    name: 'meta-ads-business',
    description: 'Business Manager: manage ad accounts, pages, pixels, users, permissions, partner sharing',
    command: 'meta-ads business',
    examples: [
      'meta-ads business get 12345',
      'meta-ads business ad-accounts 12345',
      'meta-ads business pages 12345',
      'meta-ads business pixels 12345',
      'meta-ads business users 12345',
      'meta-ads business system-users 12345',
      'meta-ads business create-system-user 12345 --name "API User" --role ADMIN',
      'meta-ads business assign-ad-account --user-id 111 --account-id act_123 --tasks ANALYZE,ADVERTISE',
      'meta-ads business share-ad-account --business-id 123 --account-id act_456 --partner-id 789',
    ],
  },
  {
    name: 'meta-ads-whatsapp',
    description: 'WhatsApp Business: send messages, manage templates, analytics',
    command: 'meta-ads whatsapp',
    examples: [
      'meta-ads whatsapp profile 12345',
      'meta-ads whatsapp phone-numbers 12345',
      'meta-ads whatsapp send-text 12345 --to 14155551234 --message "Hello!"',
      'meta-ads whatsapp send-template 12345 --to 14155551234 --template-name welcome --language en_US',
      'meta-ads whatsapp send-media 12345 --to 14155551234 --type image --url https://example.com/photo.jpg',
      'meta-ads whatsapp templates 12345',
      'meta-ads whatsapp create-template 12345 --name promo --category MARKETING --language en_US --components \'[{"type":"BODY","text":"Check out our sale!"}]\'',
      'meta-ads whatsapp analytics 12345 --start 1710000000 --end 1711000000',
    ],
  },
  {
    name: 'meta-ads-messenger',
    description: 'Messenger: send messages, bot profiles, conversations',
    command: 'meta-ads messenger',
    examples: [
      'meta-ads messenger send 12345 --recipient-id 67890 --text "Thanks for reaching out!"',
      'meta-ads messenger get-profile 12345',
      'meta-ads messenger set-profile 12345 --get-started "welcome"',
      'meta-ads messenger conversations 12345',
      'meta-ads messenger messages 67890',
    ],
  },
  {
    name: 'meta-ads-reach-frequency',
    description: 'Reach & Frequency: reserved buying, media planning predictions',
    command: 'meta-ads reach-frequency',
    examples: [
      'meta-ads reach-frequency predict --account-id act_123 --objective OUTCOME_AWARENESS --start-time 1710000000 --end-time 1711000000 --budget 500000 --targeting \'{"geo_locations":{"countries":["US"]}}\'',
      'meta-ads reach-frequency list --account-id act_123',
      'meta-ads reach-frequency get 12345',
      'meta-ads reach-frequency reserve 12345',
    ],
  },
  {
    name: 'meta-ads-branded-content',
    description: 'Branded content: creator partnerships, influencer ad boosting',
    command: 'meta-ads branded-content',
    examples: [
      'meta-ads branded-content eligible-sponsors 12345',
      'meta-ads branded-content approve-creator --page-id 123 --creator-id 456',
      'meta-ads branded-content boost-post --account-id act_123 --post-id 456_789 --adset-id 111',
    ],
  },
  {
    name: 'meta-ads-webhooks',
    description: 'Webhooks: real-time event subscriptions for leads, campaigns, messages',
    command: 'meta-ads webhooks',
    examples: [
      'meta-ads webhooks list 12345',
      'meta-ads webhooks subscribe 12345 --object page --callback-url https://example.com/webhook --verify-token mytoken --fields leadgen,messages',
      'meta-ads webhooks page-subscribe 67890 --fields feed,messages,leadgen',
    ],
  },
  {
